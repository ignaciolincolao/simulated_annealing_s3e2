...
*/
    ...
    //variables FullGPU (metropoli)
    double h_len1 = ltParams.len1;
    double h_len2 = ltParams.len2;

    cudaMemcpyToSymbol(d_len1,        &h_len1,        sizeof(double));
    cudaMemcpyToSymbol(d_len2,        &h_len2,        sizeof(double));
    cudaMemcpyToSymbol(d_coolingRate, &csParams.coolingRate, sizeof(double));
    cudaMemcpyToSymbol(d_seed,        &saParams.seed,        sizeof(int));
    cudaMemcpyToSymbol(d_current_temp, &saParams.temp, sizeof(double));
    cudaMemcpyToSymbol(d_costBestSolution, &costBestSolution, sizeof(double));
